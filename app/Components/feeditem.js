        ...
        <div className="panel-footer">
          ...
          <CommentThread onPost={(commentText) => this.handleCommentPost(commentText)}>
            {data.comments.map((comment, i) => {
              ...
              return (
                <Comment key={i} commentInd={i} attr={this.state._id} author={comment.author} likeCounter={comment.likeCounter} postDate={comment.postDate}>{comment.contents}</Comment>
              );
            })}
          </CommentThread>
        </div>
